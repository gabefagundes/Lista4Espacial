...
source("ghat.R")
pkgs <- c("tidyverse", "leaflet", "sf", "spatstat", "splancs", "sp", "spdep", "rgdal", "raster", "spatstat", "maptools", "RColorBrewer", "lattice", "geoR", "httr", "kableExtra", "scales")
...
# Não podemos considerar como um PPH 
